...
Config.DefaultSpawn = spawns[random] -- default vector3(-1035.71, -2731.87, 12.86) -- Default spawn coords if you have start apartments disabled
...
Config.PlayersNumberOfCharacters = { -- Define maximum amount of player characters by rockstar license (you can find this license in your server's database in the player table)
    { license = "license:XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", numberOfChars = 5 }, -- example
    { license = "license:XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", numberOfChars = 3 }, -- example
    { license = "license:XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", numberOfChars = 2 }, -- name
    { license = "license:XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", numberOfChars = 5 }, -- user
    { license = "license:XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", numberOfChars = 2 }, -- player
